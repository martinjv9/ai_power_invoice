...
full-stack + cloud work. The plan tells you *what* to check off; these guides
explain *what it means, how to do it, and why it's done that way*.
...
4. **Task by task** — the how *and* the why behind each item in the plan.
...
## How to use them
Read the guide for a phase *before* you start coding it. Keep the
