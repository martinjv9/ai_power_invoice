...
line items, and clean up / professionalize wording. The AI *assists*; the human
...
- **LLM (large language model):** an AI (here, Claude) that takes text and produces
  text. You send a *prompt*; it returns a completion.
...
## Task by task
1. **Integrate the Anthropic SDK (backend).** API key via env/secrets. *Why:*
